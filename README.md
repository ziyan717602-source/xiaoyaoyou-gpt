...
- 已迁移鼠儿果、冰心诀、天雷破、灵葫仙丹的普通自疗与濒死救援模式、五气朝元的全队治疗与典当模式、偷盗的匿名手牌转移、窥测天机的主遭遇牌顶私密查看与可选换序，以及铜钱镖对匿名手牌/公开装备的权威弃置；标准武器/防具基础动作、通用响应、伤害批次、濒死/死亡、权威超时和断线恢复管线也已接通。其余卡牌、受保护牌联动、四张核心牌的跨内容联动和角色技能仍按后续内容节点逐项迁移，未完成内容不会伪装成无效果卡。
