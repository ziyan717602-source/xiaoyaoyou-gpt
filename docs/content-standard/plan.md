...
| `xyy.card.tp03`  | 隐蛊        | ordinary positive HP damage uses a serialized owner-only prevention gate, all matching batch items, Bingxin cancellation, timeout and restart; copy/locust modes pending CS01D/CS02 | receipt:docs/verification/receipts/cs01c-tp03.md      |
