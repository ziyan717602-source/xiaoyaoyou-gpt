...
第一可执行切片是 `CS01A-CORE-CARD-AUDIT`：冻结鼠儿果、天雷破、冰心诀、灵葫仙丹的逐模式旧版证据，先补齐灵葫仙丹普通自疗，再把四项逐一提升到带收据的 verified。
...
| `xyy.card.tp02`  | 灵葫仙丹    | dying rescue-two mode only; normal self-heal mode pending                                            | M05-DAMAGE-DYING                    |
